...
::: {.column}
[![LinkedIn](image/linkedln.png)](https://www.linkedin.com/in/erika-atoma-data/){width=8%}
:::

::: {.column}
![Medium: @atomamaro](image/medium.png)
:::

::: {.column}
[![Github](image/github.png)](https://github.com/erica-prog/portfolio){width=8%} 
:::
:::
